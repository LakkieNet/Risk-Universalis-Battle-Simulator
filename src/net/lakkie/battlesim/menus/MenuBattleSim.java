...
public class MenuBattleSim extends JFrame implements WindowListener {
	...
	public MenuBattleSim(RUBSBattle battle) {
		...
		panel.setBorder(new TitledBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null), "Battle", TitledBorder.TRAILING, TitledBorder.TOP, null, new Color(0, 0, 0)));
